...
parser.add_argument('--spk-num', type=int, help='number of speakers')
...
parser.add_argument('--model', type=str, default='resnet34', help='feature extractor model type')
...
parser.add_argument('--min-chunk-size', type=int, default=200, help='minimum feature map length')
parser.add_argument('--max-chunk-size', type=int, default=400, help='maximum feature map length')
